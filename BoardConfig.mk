...
BOARD_PREBUILT_BOOTIMAGE := device/qcom/parrot66/boot.img
...
AB_OTA_UPDATER := true
TARGET_RECOVERY_FSTAB := device/qcom/parrot66/recovery.fstab
else
TARGET_RECOVERY_FSTAB := device/qcom/parrot66/recovery_non_AB.fstab
