...
VENDOR_FOREACH_WHITELIST = {
    "device/qcom/common/utils.mk",
    "device/qcom/parrot66/parrot66.mk",
    "device/qcom/wlan/parrot/BoardConfigWlan.mk",
    "device/qcom/wlan/parrot/wlan.mk",
    "vendor/qcom/opensource/audio-hal/primary-hal/configs/parrot/parrot.mk",
...
VENDOR_SOONG_WHITELIST = {
    "device/qcom/parrot66/BoardConfig.mk",
